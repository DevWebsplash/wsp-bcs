...
$site_options = get_cached_acf_options();
...
<section class="s-vehicles ms-section">
  <div class="s-vehicles__head">
    <div class="cn">
      ...
      //				            ?>
      <!--                      <option data-make="--><?php //echo esc_attr($term->term_id); ?><!--" value="-->
      <?php //echo esc_attr($term->slug); ?><!--"--><?php //echo $is_active; ?><!-->-->
      ...
      //							          ?>
      <!--                          <option data-model="-->
      <?php //echo esc_attr($child_term->term_id); ?><!--" value="-->
      <?php //echo esc_attr($child_term->slug); ?><!--"--><?php //echo $is_active; ?><!-->-->
      ...
      <!--                          <option data-model="-->
      <?php //echo esc_attr($child_term->term_id); ?><!--" value="-->
      <?php //echo esc_attr($child_term->slug); ?><!--">-->
      <!--									          --><?php //echo esc_html($child_term->name); ?>
      <!--                          </option>-->
      <!--						          --><?php //}
      //					          } ?>
    ...
    <section class="s-specialists-reviews ms-section">
      ...
      <div class="cn cn--big">
        <div class="section-heading">
          ...
          <h2 class="title h1"><?php echo $site_options['portfolio_title']; ?></h2>
          <div class="subtitle"><?php echo $site_options['portfolio_subtitle']; ?></div>
        </div>
...
<section class="s-services-main ms-section">
  <div class="s-services-main__head">
    ...
    <div class="cn">
      <div class="section-heading">
        <h2 class="title h1"><?php echo $site_options['services_title']; ?></h2>
        <div class="subtitle"><?php echo $site_options['services_subtitle']; ?></div>
...
if ($query->have_posts ()) :?>
  ...
  <section class="s-products ms-section">
    <div class="cn">
      <div class="section-heading">
        <h2 class="title h1"><?php echo $site_options['product_title']; ?></h2>
        <div class="subtitle"><?php echo $site_options['products_subtitle']; ?></div>
      </div>
      ...
      <div class="section-btn"><a href="/staging/products/brake-caliper-paint-kits/" class="btn btn-1">View all</a>
      </div>
    </div>
  </section>
<?php endif;
