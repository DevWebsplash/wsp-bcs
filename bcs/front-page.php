...
// Second query, specific posts query
      ...
      if ($query->have_posts ()) :?>
        ...
        <section class="s-specialists-reviews ms-section">
          <div class="section-bg"><img
                    src="<?php echo get_template_directory_uri (); ?>/assets/images/bg-01.png" loading="lazy"
                    alt=""></div>
          <div class="cn cn--big">
            <div class="section-heading">
              <div class="decorated-title decorated-title--column-center">
              ...
              while ($query->have_posts ()) :
                ...
                <div class="sr-item">
                  ...
                  <div class="sr-item__content">
                    ...
                    <div class="tags">
                      <?php
                      $terms = wp_get_object_terms ($post->ID, 'portfolio_category', array(
                          'orderby' => 'term_id',
                          'order' => 'ASC'
                      ));
                      if (!empty($terms)) :
    ...
    <?php elseif (get_row_layout () == 'experienced'): ?>
      ...
      <section class="s-banner-2 ms-section">
        <div class="section-bg"><img src="<?php echo get_template_directory_uri (); ?>/assets/images/bg-03.png"
                                     loading="lazy" alt=""></div>
        <div class="cn">
          ...
          <div class="partners-logos">
            <?php if (have_rows ('we_work_logos')): ?>
              <?php while (have_rows ('we_work_logos')) : the_row (); ?>
                ...
                <div class="item"><img src="<?php echo esc_url ($image_repeater[ 'url' ]); ?>"
                                       loading="lazy"
                                       alt="<?php echo esc_attr ($image_repeater[ 'alt' ]); ?>">
                </div>
              <?php endwhile; ?>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="item">
                  ...
                  <div class="text">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit
                    officia consequat duis enim sit aliqua dolor do amet sint. Velit officia consequat duis enim sit
