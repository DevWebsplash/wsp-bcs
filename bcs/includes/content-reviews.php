...
<section class="s-testimonials-main ms-section">
  <div class="s-testimonials-main__head">
    <div class="section-bg">
      <img src="<?php echo get_template_directory_uri (); ?>/assets/images/bg-04.png" loading="lazy"
           alt="reviews_background"></div>
    <div class="cn">
  ...
  <div class="cn">
    ...
    <div class="b-popularity ms-section">
      <?php $trustpilot_link = get_field ('trustpilot_link', 'option'); ?>
      <a href="<?php echo esc_url ($trustpilot_link); ?>" class="item" target="_blank" rel="noopener">
        <?php $image_repeater = get_field ('trustpilot_image', 'option'); ?>
        <div class="img">
          <img src="<?php echo esc_url ($image_repeater[ 'url' ]); ?>" loading="lazy" alt="<?php echo esc_attr ($image_repeater[ 'alt' ]); ?>">
        </div>
        <div class="text">
          <span><?php echo get_field ('trustpilot__rate', 'option'); ?></span> <?php echo get_field ('trustpilot_number', 'option'); ?>
        </div>
      </a>
      <?php $google_link = get_field ('google_link', 'option'); ?>
      <a href="<?php echo esc_url ($trustpilot_link); ?>" class="item" target="_blank" rel="noopener">
        ...
        <div class="text">
          <span><?php echo get_field ('google_rate', 'option'); ?></span> <?php echo get_field ('google_number', 'option'); ?>
        </div>
      </a>
      <?php $facebook_link = get_field ('facebook_link', 'option'); ?>
      <a href="<?php echo esc_url ($facebook_link); ?>" class="item" target="_blank" rel="noopener">
        <?php $image_repeater = get_field ('facebook_image', 'option'); ?>
        <div class="img">
          <img src="<?php echo esc_url ($image_repeater[ 'url' ]); ?>" loading="lazy" alt="<?php echo esc_attr ($image_repeater[ 'alt' ]); ?>">
        </div>
        <div class="text">
          <span><?php echo get_field ('facebook_rate', 'option'); ?></span> <?php echo get_field ('facebook_number', 'option'); ?>
        </div>
      </a>
    </div>
  </div>
